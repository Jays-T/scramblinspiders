...
export function showBeginButton() {
    ...
    let introJumpScareAudio = '/scramblinspiders/static/assets/audio/jump_scares/jump_scare_one.mp3';
    let scareImage = '/scramblinspiders/static/assets/images/pumpkin-992318_1280.png';
